...
<html>
	...
	<head>
		...
		<link href="Validform/css/style.css" rel="stylesheet" type="text/css">
			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="user-info">
						...
						<!--个人信息 -->
						<div class="info-main">
							<form class="am-form am-form-horizontal" action="UserServlet?action=modifeRegistInfo" method="post" id="form">

								<div class="am-form-group">
									<label for="user-name2" class="am-form-label">昵称</label>
									<div class="am-form-content">
										<input type="text" id="user-name2"  name="nick_name" placeholder="nickname" datatype="s5-16" errormsg="昵称至少5个字符,最多16个字符！">
							...
							<div class="am-form-group">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-code" placeholder="Code" name="codes" type="text">
